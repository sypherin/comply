...
from .models.schemas import REQUIRED_HEADERS, normalize_status_values, validate_headers
from .components.kpis import render_kpis
from .components.charts import render_course_chart
from .services.auth_easy_auth import get_user_from_easy_auth
from .services.auth_msal import ensure_sign_in, get_access_token
from .services.graph_client import GraphClient
from .services.data_store import InMemoryStore, SqlStore, get_sql_engine
from .services.security import scan_csv_basic
...
def require_auth() -> dict:
    ...
    if ALLOWED_EMAIL_DOMAINS and not any(email.endswith("@" + d) or email.split("@")[-1] == d for d in ALLOWED_EMAIL_DOMAINS):
